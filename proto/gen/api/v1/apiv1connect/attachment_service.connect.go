...
const (
	...
	AttachmentServiceName = "api.v1.AttachmentService"
)
...
const (
	...
	AttachmentServiceCreateAttachmentProcedure = "/api.v1.AttachmentService/CreateAttachment"
	// AttachmentServiceListAttachmentsProcedure is the fully-qualified name of the AttachmentService's
	// ListAttachments RPC.
	AttachmentServiceListAttachmentsProcedure = "/api.v1.AttachmentService/ListAttachments"
	// AttachmentServiceGetAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// GetAttachment RPC.
	AttachmentServiceGetAttachmentProcedure = "/api.v1.AttachmentService/GetAttachment"
	// AttachmentServiceDeleteAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// DeleteAttachment RPC.
	AttachmentServiceDeleteAttachmentProcedure = "/api.v1.AttachmentService/DeleteAttachment"
	// AttachmentServiceUpdateAttachmentProcedure is the fully-qualified name of the AttachmentService's
	// UpdateAttachment RPC.
	AttachmentServiceUpdateAttachmentProcedure = "/api.v1.AttachmentService/UpdateAttachment"
)

// AttachmentServiceClient is a client for the api.v1.AttachmentService service.
...
// NewAttachmentServiceClient constructs a client for the api.v1.AttachmentService service. By
...
// CreateAttachment calls api.v1.AttachmentService.CreateAttachment.
...
// ListAttachments calls api.v1.AttachmentService.ListAttachments.
...
// GetAttachment calls api.v1.AttachmentService.GetAttachment.
...
// DeleteAttachment calls api.v1.AttachmentService.DeleteAttachment.
...
// UpdateAttachment calls api.v1.AttachmentService.UpdateAttachment.
...
// AttachmentServiceHandler is an implementation of the api.v1.AttachmentService service.
...
func NewAttachmentServiceHandler(svc AttachmentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.v1.AttachmentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAttachmentServiceHandler) CreateAttachment(context.Context, *connect.Request[v1.CreateAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AttachmentService.CreateAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) ListAttachments(context.Context, *connect.Request[v1.ListAttachmentsRequest]) (*connect.Response[v1.ListAttachmentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AttachmentService.ListAttachments is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) GetAttachment(context.Context, *connect.Request[v1.GetAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AttachmentService.GetAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) DeleteAttachment(context.Context, *connect.Request[v1.DeleteAttachmentRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AttachmentService.DeleteAttachment is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) UpdateAttachment(context.Context, *connect.Request[v1.UpdateAttachmentRequest]) (*connect.Response[v1.Attachment], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.AttachmentService.UpdateAttachment is not implemented"))
}
